...
<head>
    ...
    <meta name="description" content="Aleksey Novikov - Senior PHP Developer">
    <meta name="keywords" content="portfolio">
    <meta name="author" content="Aleksey Novikov">

    <title>Aleksey Novikov</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css')}}">
...
<div id="page" class="hfeed site">
    ...
    <header id="masthead" class="header" role="banner">
        ...
        <h1 class="site-title mobile-title">Aleksey Novikov</h1>
        ...
        <div class="header-wrap">
            ...
            <h1 class="site-title">ALEKSEY NOVIKOV</h1>
    ...
    <div id="main" class="site-main"> <!-- PAGE : HOME -->
        <section id="home" class="pt-page page-layout light-text home-section has-bg-img"
                 style="background-image:url(images/site/home.jpg)">
            <!-- .content -->
            <div class="content">
                <!-- .layout-medium -->
                <div class="layout-medium">
                    ...
                    <h4>Hi, I am</h4>
                    <h2>Aleksey Novikov</h2>
                    <h4>I am <strong id="typist-element" data-typist="a Laravel lover., a wordpress lover., an adventurer.">a PHP/JS developer.</strong></h4>
                </div>
                <!-- .layout-medium -->
            </div>
            <!-- .content -->
                ...
                <div class="layout-medium">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <div class="service">
                                ...
                                <img src="{{asset('images/site/icon-01.png')}}" alt="image"/>
                                <h4>Copywriter</h4>
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <div class="service">
                                <!--<i class="pe-7s-joy"></i>-->
                                <img src="{{asset('images/site/icon-02.png')}}" alt="image"/>
                                <h4>Game Dev</h4>
                                <p>I can design beautiful type faces for both digital and print media. It is a long
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <div class="service">
                                ...
                                <img src="{{asset('images/site/icon-03.png')}}" alt="image"/>
                                <h4>Management</h4>
                                <p>I write about web design. It is a long established fact that a reader will be
                                    distracted by the readable content.</p>
                            </div>
                            <!-- service -->
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <div class="service">
                                ...
                                <img src="{{asset('images/site/icon-04.png')}}" alt="image"/>
                                <h4>Problem Solver</h4>
                                <p>I have strong project management skills. It is a long established fact that a reader
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4 col-md-2">
                            ...
                            <div class="client">
                                <a href="#">
                                    <img src="{{asset('images/clients/client-01.png')}}" alt="client">
                                </a>
                            </div>
                            <!-- client -->
                        ...
                        <div class="col-xs-4 col-md-2">
                            ...
                            <div class="client">
                                <a href="#">
                                    <img src="{{asset('images/clients/client-02.png')}}" alt="client">
                                </a>
                            </div>
                            <!-- client -->
                        ...
                        <div class="col-xs-4 col-md-2">
                            ...
                            <div class="client">
                                <a href="#">
                                    <img src="{{asset('images/clients/client-03.png')}}" alt="client">
                                </a>
                            </div>
                            <!-- client -->
                        ...
                        <div class="col-xs-4 col-md-2">
                            ...
                            <div class="client">
                                <a href="#">
                                    <img src="{{asset('images/clients/client-04.png')}}" alt="client">
                                </a>
                            </div>
                            <!-- client -->
                        ...
                        <div class="col-xs-4 col-md-2">
                            ...
                            <div class="client">
                                <a href="#">
                                    <img src="{{asset('images/clients/client-05.png')}}" alt="client">
                                </a>
                            </div>
                            <!-- client -->
                        ...
                        <div class="col-xs-4 col-md-2">
                            ...
                            <div class="client">
                                <a href="#">
                                    <img src="{{asset('images/clients/client-06.png')}}" alt="client">
                                </a>
                            </div>
                            <!-- client -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="event">
                                ...
                                <h5>Pixelwars Inc.</h5>
                                <p>I currently work for Pixelwars creative studio. I create usable web interfaces, front
                            ...
                            <div class="event">
                                ...
                                <h4>Web Developer</h4>
                                <h5>Google Inc.</h5>
                                <p>I worked as a Web Developer at Google for 3 years. I create usable web interfaces,
                                    front end coding stuff and almost anything. But i love what i do.</p>
                            </div>
                            ...
                            <div class="event">
                                ...
                                <h5>Envato Inc.</h5>
                                <p>I am an Elite Author at Envato. I create usable web interfaces, front end coding
                            ...
                            <div class="event">
                                ...
                                <p>I studied atomic stuff at Stanford University. I create usable web interfaces, front
                                    end coding stuff and almost anything. But i love what i do.</p>
                            </div>
                            ...
                            <div class="event">
                                ...
                                <p>I got my Master Degree at Harvard University. I create usable web interfaces, front
                                    end coding stuff and almost anything. But i love what i do.</p>
                            </div>
                            ...
                            <div class="event">
                                ...
                                <h5>MIT</h5>
                                <p>I studied Computer Science at MIT. I create usable web interfaces, front end coding
                                    stuff and almost anything. But i love what i do.</p>
                            </div>
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="testo">
                                ...
                                <p>He is a great and hardworking guy. I am so proud of i have him as my asistant. He
                                    helped me so much. Also i am so proud of i have him as my asistant. He helped me so
                                    much.</p>
                            ...
                            <div class="testo">
                                ...
                                <p>He was a great co-worker and a friend. I would't be where i am without his
                                    support.</p>
                    ...
                    <div class="portfolio-items media-grid masonry" data-layout="masonry" data-item-width="340">
                        ...
                        <div class="media-cell illustration video hentry">
                            ...
                            <div class="media-box">
                                ...
                                <div class="mask"></div>
                                <!-- lightbox - video -->
                                <a href="https://vimeo.com/67658001" title="Lightbox Title"
        ...
        <section id="contact" class="pt-page page-layout contact light-text">
            ...
            <div class="content">
                ...
                <div class="layout-medium">
                    ...
                    <!-- GOOGLE MAP -->
                    <div class="map">
                        <div data-latitude="-25.363882" data-longitude="131.044922" data-zoom="5"
                             data-marker-image="{{asset('images/site/marker.png')}}" id="map-canvas" class="map-canvas"></div>
                    </div>
                    <!-- GOOGLE MAP -->
...
<script src="{{asset('js/typist.js')}}"></script>
<script src="{{asset('js/imagesloaded.pkgd.min.js')}}"></script>
<script src="{{asset('js/jquery.isotope.min.js')}}"></script>
<script src="{{asset('js/jquery.fitvids.js')}}"></script>
<script src="{{asset('js/jquery.validate.min.js')}}"></script>
<script src="{{asset('js/jquery.uniform/jquery.uniform.min.js')}}"></script>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBHBFckrwJisuH3NVbEEtiRPqblBhkUk8o"></script>
